...
6. Start server: Run main class <tt>no.statkraft.larm.poc.web.WebServer</tt>
   * IDEA: Make sure Working Directory is project directory
7. Start client: Run main class <tt>no.statnett.larm.poc.client.ApplicationFrame</tt>
...
* <tt>no.statnett.larm.poc.client.stasjon.StasjonListDialogTest</tt> describes
  the mapping between the domain and the user interface
* <tt>no.statnett.larm.poc.client.stasjon.StasjonSpecificationTest</tt> describes
